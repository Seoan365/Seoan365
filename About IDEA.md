...
# Natively integrated AI
  ...
  <tr>
    <td>
      ...
      <code>Claude, GPT, Gemini, Grok</code>
      or a local model of your choice.
    </td>
    <td>
      <h4>Multi-agent experience</h4>
      <code>Junie, Claude Agent, Codex</code>
      and more, including GitHub Copilot and Cursor via ACP.
    </td>
  </tr>
  <tr>
    <td>
      <h4>Next edit suggestions and unlimited code completion</h4>
      Fast, accurate code suggestions as you type, powered by deep IDE intelligence.
    </td>
    <td>
      <h4>Transparent AI costs without vendor lock-in</h4>
      Use a JetBrains AI subscription or connect your preferred provider with Bring Your Own Key (BYOK).
    </td>
  </tr>
</table>
  
<img width="2552" height="1308" alt="image" src="https://github.com/user-attachments/assets/eab728dd-c440-43e2-90d7-1c4e5898f220" />
